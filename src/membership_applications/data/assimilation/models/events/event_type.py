...
class EventType(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True, index=True, name="Id_Tipo_Evento")
    description: Mapped[str] = mapped_column(unique=True, index=True, nullable=False, name="Descripcion")
    events: Mapped[list["Event"]] = relationship("Event", back_populates="event_type")

    def __repr__(self) -> str:
        return f"<EventType(id={self.id}, description={self.description})>"